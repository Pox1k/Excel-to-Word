...
time_keys = {}
names = [
    "Залуський Сергій", "Козел Михайло", "Толстеньов Микола", "Мельничук Михайло", "Зубчик Андрій",
    "Новак Микола", "Власюк Віталій", "Нечипорук Станіслав", "Грищук Олександр", "Шворак Віктор",
    "Чирук Олег", "Шевчук Наталія", "Сидорук Ігор", "Пригородов Євген", "Кобзар Станіслав",
    "Шпирук Андрій", "Тупчій Олександр", "Калінчук Олександр", "Власюк Людмила", "Солодуха Василь",
    "Попіка Ярослав", "Матардей Андрій", "Рудін Сергій", "Білінець Людмила", "Мохнюк Олександр", 
    "Максимук Сергій", "Дяченко Юрій", "Кот Роман", "Клімчук Юрій", "Ніколайчук Віктор", 
    "Бідун Андрій", "Доменюк Сергій", "Терета Руслан", "Дятел Володимир", "Романюк Іван", 
    "Пшонюк Володимир", "Щесюк Дмитро", "Кульчинський Віталій", "Чуль Наталія", "Готь Валентин", 
    "Спірін Василь"
]
